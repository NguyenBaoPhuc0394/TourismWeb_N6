...
namespace TourismWeb.Services.Implementations
{
    public class TourService : ITourService
    {
        ...
        public async Task<TourDTO> CreateTour(TourCreateDTO tourDTO)
        {
            ...
            var createdTour = await _tourRepository.CreateTour(tour);
        ...
        public async Task<TourCreateDTO> UpdateTourById(string id, TourCreateDTO updatedTourDTO)
        {
            var updatedTour = _mapper.Map<Tour>(updatedTourDTO);
            var tour = await _tourRepository.UpdateTourById(id, updatedTour);
