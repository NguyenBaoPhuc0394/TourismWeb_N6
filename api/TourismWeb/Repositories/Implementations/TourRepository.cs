...
namespace TourismWeb.Repositories.Implementations
{
    public class TourRepository : ITourRepository
    {
        ...
        public async Task<Tour> CreateTour(TourCreateDTO tour)
        {
            try
            {
                var result = _context.Tours.FromSqlRaw("Exec CreateTour @Name = {0}, @ShortDescription = {1}, @DetailDescription = {2}, @ScheduleDescription = {3}, @CategoryId = {4}, @Duration = {5}, @Price = {6}, @MaxCapacity = {7}, @LocationId = {8}",
                tour.Name, tour.Short_description, tour.Detail_description, tour.Schedule_description, tour.Category_Id, tour.Duration, tour.Price, tour.Max_capacity, tour.Location_Id).AsEnumerable().FirstOrDefault();
        ...
        public async Task<Tour> UpdateTourById(string id, TourUpdateDTO tourUpdate)
        {
